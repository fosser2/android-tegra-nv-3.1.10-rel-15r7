/*
 * max98088.c -- MAX98088/MAX98089 ALSA SoC Audio driver
 *
...
static unsigned int max98088_read(struct snd_soc_codec *codec, unsigned int reg)
{
			     ...
			     struct snd_kcontrol *kcontrol, int event)
{
	...
	if ((status & M98088_HPEN) == M98088_HPEN) {
		snd_soc_write(codec, M98088_REG_4D_PWR_EN_OUT,
			(status & ~M98088_HPEN));
	}
			     ...
			     const struct i2c_device_id *id)
{
	...
	codec->control_data = i2c; /* max98088->control_data */
	codec->dev = &i2c->dev;
...
MODULE_DESCRIPTION("ALSA SoC MAX98088/MAX98089 driver");
