/*
 * arch/arm/mach-tegra/board-smba9701-touch.c
 *
...
{
	tegra_gpio_enable(SMBA9701_TS_IRQ);
	gpio_request(SMBA9701_TS_IRQ, "at168_touch");
	gpio_direction_input(SMBA9701_TS_IRQ);
