...
static void tegra3_clk_shared_bus_update(struct clk *bus)
{
	...
	if (rate != old_rate)
		shared_bus_set_rate(bus, rate, old_rate);
};
...
struct clk tegra_list_clks[] = {
	...
	PERIPH_CLK("i2s0",      "i2s.4",		NULL,   30,	0x1d8,	100000000,  mux_pllaout0_audio0_2x_pllp_clkm,	MUX | DIV_U71 | PERIPH_ON_APB),
	PERIPH_CLK("i2s1",	"i2s.0",		NULL,	11,	0x100,	100000000,  mux_pllaout0_audio1_2x_pllp_clkm,	MUX | DIV_U71 | PERIPH_ON_APB),
	PERIPH_CLK("i2s2",	"i2s.1",		NULL,	18,	0x104,	100000000,  mux_pllaout0_audio2_2x_pllp_clkm,	MUX | DIV_U71 | PERIPH_ON_APB),
	PERIPH_CLK("i2s3",      "i2s.2",		NULL,   101,	0x3bc,	100000000,  mux_pllaout0_audio3_2x_pllp_clkm,	MUX | DIV_U71 | PERIPH_ON_APB),
	PERIPH_CLK("i2s4",      "i2s.3",		NULL,   102,	0x3c0,	100000000,  mux_pllaout0_audio4_2x_pllp_clkm,	MUX | DIV_U71 | PERIPH_ON_APB),
