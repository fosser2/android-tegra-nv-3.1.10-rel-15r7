/*
 * arch/arm/mach-tegra/board-smba1007-pinmux.c
 *
...
static struct tegra_gpio_table gpio_table[] = {
	{ .gpio = SMBA1007_SDHC_CD,			.enable = true	},
	{ .gpio = SMBA1007_SDHC_WP,			.enable = true	},
	{ .gpio = SMBA1007_SDHC_POWER,		.enable = true	},
	{ .gpio = SMBA1007_SDINT_POWER,		.enable = true	},
	//{ .gpio = TEGRA_GPIO_CDC_IRQ,		.enable = true	}, //harmony audio gpio
	{ .gpio = SMBA1007_HP_DETECT,		.enable = true	},
	{ .gpio = SMBA1007_INT_MIC_EN,		.enable = true	},
	{ .gpio = SMBA1007_AC_PRESENT,    	.enable = true  },
	{ .gpio = SMBA1007_USB0_VBUS,		.enable = false },
	{ .gpio = SMBA1007_ENABLE_VDD_VID,  	.enable = true  }, //FIX MEEE
};
